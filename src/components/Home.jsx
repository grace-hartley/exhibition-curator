    ...
    <>
      ...
      <div className="m-6 space-y-3">
        ...
        <div className="text-gray-700 leading-relaxed space-y-4">
          ...
          <p>
            To get started, browse the gallery below or use the search bar to
            start exporing, where you can further refine your search. If you
            want to find out more about a piece of art, simply click on the
          ...
          <p>
            But be careful! When you close the browser your collection goes with
